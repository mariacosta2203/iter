...
public class UsuarioController {
	...
	@PostMapping("/logar")
	public ResponseEntity<UsuarioLoginModel> autenticarUsuario(@RequestBody Optional<UsuarioLoginModel> usuarioLogin){
